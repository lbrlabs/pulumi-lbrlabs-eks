...
Define the typed public API and provider behavior for optional Amazon VPC CNI configuration on EKS clusters, including network policy support and nested node agent settings.
